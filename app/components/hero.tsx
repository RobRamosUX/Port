  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
        ...
        >
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/1771512173245.jfif-UKABrj1lFevJSLZjpfUX9dDozfV8pU.jpeg"
            alt="Robson Ramos"
        ...
        >
          Liderança em Design e Produto - UX Strategy - IA & Automação - Experiências Escaláveis
        </motion.p>
